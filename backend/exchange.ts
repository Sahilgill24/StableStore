...
const toChainId = "43114"; // Avalanche
const fromChainId = "314"; // Filecoin
const toToken = "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E"; // USDC
const fromToken = "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE"; // FIL
