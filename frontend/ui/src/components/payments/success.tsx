...
export default function SuccessfulPayment(props: props) {
      ...
      if (res.status === 200) {
        ...
        try {
          ...
          if (omsoRes.status === 200) {
            setOsmoSuccess(true);
            console.log(omsoRes.data.data);
            setOsmoHash(omsoRes.data.data);
                ...
                <>
                  <div className="flex mb-1 gap-2 items-end">
                    <div className="flex-1">
                      ...
                      <Input id="osmosisTxHash" value={osmoHash} />
                    </div>
